            ...
            <ul>
             <li>
                ...
                <div class="userdata_cont">
                  <input name="user.realName" type="text" class="userdataname" validate-method="requiredString" validate-errorTips="请输入正确的姓名">
                </div>
             ...
             <li>
                ...
                <div class="userdata_cont">
                  <input name="user.mobile" type="text" class="userdataname" validate-method="requiredMobile" validate-errorTips="请输入正确的手机号" >
                </div>
             ...
             <li>
                ...
                <div class="userdata_cont">
                  <input name="user.password" type="text" class="userdataname"  value="yf112233" readonly="readonly">
                </div>
                <div class="userdata_prompt"><span></span></div>
              </li>
              <li>
                ...
                <div class="userdata_cont">
                  <select name="user.roleId" validate-method="requiredSelect" validate-errorTips="至少选择一个角色">
                    	<option disabled="disabled" selected value="" >请选择一个角色</option>
              ...
              <li>
                ...
                <div class="userdata_cont">
                  <select name="user.channelId" validate-method="requiredSelect" validate-errorTips="至少选择一个公司">
                    <option disabled="disabled" selected value="" >请选择一个公司</option>
    				...
    				submitButton: {											
    					...
    					success : function() {							//点击提交的按钮,重新验证所有的输入框，成功后执行的回调函数
    						//$("form").submit();
    																	...
    																	//ajax提交表单配置参数
    				ajax : {
    					url:"${base}/user/add?timestamp=<%=System.currentTimeMillis()%>",
    					type:"post",
    					...
    					success : function(msgType) {
    						if(msgType==0) {
    							yofangTip.openFirst("保存用户成功", function(element){
